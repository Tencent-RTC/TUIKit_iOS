...
public class RoomSelectAttendeesViewController: UIViewController, RouterContext {
    ...
    private let mode: RoomSelectAttendeesView.Mode

    private lazy var attendeesView: RoomSelectAttendeesView = {
        let view = RoomSelectAttendeesView(initialSelectedUserIDs: initialSelectedUserIDs, mode: mode)
    ...
    public init(initialSelectedUserIDs: [String], mode: RoomSelectAttendeesView.Mode = .schedule) {
