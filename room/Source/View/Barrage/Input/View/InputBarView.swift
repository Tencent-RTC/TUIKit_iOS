...
class InputBarView: UIView {
    ...
    lazy var emotionSwitchButton: UIButton = {
        let button = UIButton()
        button.setImage(ResourceLoader.loadImage("room_emoji_icon"), for: .normal)
        button.setImage(ResourceLoader.loadImage("room_barrage_softkeyboard"), for: .selected)
    ...
    lazy var inputTextView: UITextView = {
        ...
        view.font = RoomFonts.pingFangSCFont(size: 15, weight: .medium)
...
private extension String {
    static let sendText = "roomkit_barrage_btn_send".localized
}
