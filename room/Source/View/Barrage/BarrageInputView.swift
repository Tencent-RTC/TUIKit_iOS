...
public class BarrageInputView: UIView {
    ...
    private lazy var emojiButton: UIButton = {
        let button = UIButton()
        button.setImage(ResourceLoader.loadImage("room_emoji_icon")?.withTintColor(.white.withAlphaComponent(0.55)), for: .normal)
...
private extension String {
    static let chatText = "roomkit_barrage_text_hint".localized
}
