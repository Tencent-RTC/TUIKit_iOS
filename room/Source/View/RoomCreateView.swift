...
extension RoomCreateView {
    ...
    @objc private func handleCreateRoomButtonTapped() {
        ...
        options.roomName = selectedRoomType == .standard ? .roomName.localizedReplace(name) : .webinarRoomName.localizedReplace(name)
...
fileprivate extension String {
    ...
    static let webinarRoomName = "roomkit_user_webinar_room"
