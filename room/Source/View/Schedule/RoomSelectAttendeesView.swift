...
public class RoomSelectAttendeesView: UIView, BaseView {
    public enum Mode {
        ...
        var titleKey: String {
            switch self {
            case .schedule: return "roomkit_select_attendee_title"
            case .invite:   return "roomkit_scheduled_invite_members"
            }
        }
    }
    ...
    private lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = mode.titleKey.localized
    ...
    public init(initialSelectedUserIDs: [String], mode: Mode = .schedule) {
