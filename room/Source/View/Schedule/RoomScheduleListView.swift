...
private class RoomScheduleListCell: UITableViewCell {
    ...
    private lazy var enterButton: UIButton = {
        ...
        button.backgroundColor = RoomColors.scheduleEnterButtonBgColor
    ...
    func configure(with item: RoomInfo,
        ...
        case .scheduled:
            statusLabel.text = .statusNotStarted
            statusLabel.textColor = RoomColors.statusNotStartedColor
        }
    }
...
private extension String {
    ...
    static let statusNotStarted = "roomkit_scheduled_status_not_started".localized
}
