...
extension RoomBottomBarView: StandardRoomBottomBarViewDelegate, WebinarRoomBottomBarViewDelegate {
    ...
    public func onShowToast(message: String, style: ToastStyle) {
        delegate?.onShowToast(message: message, style: style)
    }
