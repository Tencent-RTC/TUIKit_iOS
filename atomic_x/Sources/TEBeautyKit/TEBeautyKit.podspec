...
TODO: Add long description of the pod here.
  ...
  s.source           = { :http => 'https://liteav.sdk.qcloud.com/app/tuikit/download/release/1.5/TEBeautyKit_iOS_1.5.0.zip' }
  ...
  s.subspec 'Default' do |default|
    default.dependency 'TencentEffect_Game'
  ...
  s.subspec 'AllInOne' do |default|
    default.dependency 'TencentEffect_S1-07', '< 4.0.0'
    default.dependency 'Masonry'
    default.dependency 'SSZipArchive'
    default.dependency 'AFNetworking'
