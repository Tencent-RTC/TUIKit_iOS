...
final class TranscriberSettingsViewController: UIViewController {
    ...
    static func show(from viewController: UIViewController, onDismiss: (() -> Void)? = nil) {
    ...
    @objc private func onBackButtonTapped() {
        ...
        AITranscriberStore.shared.updateRealtimeTranscriber(config: newConfig) { result in
