...
- (void)initUI {
    ...
    [_lbStrength mas_makeConstraints:^(MASConstraintMaker *make) {
      make.leading.equalTo(_topPanel).inset(16);
      make.centerY.equalTo(_topPanel);
    }];
    [_imgViewCompare mas_makeConstraints:^(MASConstraintMaker *make) {
      make.trailing.equalTo(_topPanel).inset(16);
      make.centerY.equalTo(_topPanel);
      make.width.height.mas_equalTo(30);
    }];
    [_slider mas_makeConstraints:^(MASConstraintMaker *make) {
      make.leading.equalTo(_lbStrength.mas_trailing).inset(8);
      make.trailing.equalTo(_imgViewCompare.mas_leading).inset(8);
      make.centerY.equalTo(_topPanel);
    ...
    [_tabPanel mas_makeConstraints:^(MASConstraintMaker *make) {
      make.leading.trailing.top.equalTo(bottomPanel);
