...
- (void) initSendAndCancelBtn {
    ...
    [_btnCancel setImage:[VideoRecorderBundleThemeImage(@"return_arrow") imageFlippedForRightToLeftLayoutDirection] forState:UIControlStateNormal];
    ...
    [_btnCancel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.leading.equalTo([[MASViewAttribute alloc] initWithView:self item:self.safeAreaLayoutGuide layoutAttribute:NSLayoutAttributeLeading]).offset(15);
    }];
}
