...
public class ThemeState: ObservableObject {
    ...
    var hasCustomPrimaryColor: Bool {
    ...
    var fonts: SemanticFontScheme {
        return FontScheme
    }

    var radius: SemanticRadiusScheme {
        return RadiusScheme
    }
    ...
    public func setPrimaryColor(_ hex: String) {
        clearCache()
        currentTheme = ThemeConfig(mode: currentTheme.mode, primaryColor: hex)
        saveTheme()
    }
    ...
    private func calculateColorScheme() -> SemanticColorScheme {
        ...
        if let primaryColor = currentTheme.primaryColor {
            let customColor = UIColor(hexString: primaryColor)
    ...
    private func getCustomScheme(isLight: Bool, baseScheme: SemanticColorScheme, primary: UIColor) -> SemanticColorScheme {
        ...
        let themeLight1 = UIColor(hexString: lightPalette[0])
        let themeLight2 = UIColor(hexString: lightPalette[1])
        let themeLight5 = UIColor(hexString: lightPalette[4])
        let themeLight6 = UIColor(hexString: lightPalette[5])
        let themeLight7 = UIColor(hexString: lightPalette[6])
        let themeDark2 = UIColor(hexString: darkPalette[1])
        let themeDark5 = UIColor(hexString: darkPalette[4])
        let themeDark6 = UIColor(hexString: darkPalette[5])
        let themeDark7 = UIColor(hexString: darkPalette[6])
