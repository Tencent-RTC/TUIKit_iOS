...
public struct BrandColorToken {
    ...
    public static func generate(from baseColorString: String, themeMode: ThemeMode) -> BrandColorToken {
        let colors = ThemeColorGenerator.generateThemeColors(baseColor: baseColorString, themeMode: themeMode)
