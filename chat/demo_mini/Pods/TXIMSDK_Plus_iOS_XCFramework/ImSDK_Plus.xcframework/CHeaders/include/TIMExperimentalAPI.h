...
static const char* kTIMInternalOperationRequestFriendInfoWhenFetchingGroupMemberList = "internal_operation_request_friend_info_when_fetching_group_member_list";
...
// bool, 只写(必填), 设置拉取群成员时是否请求好友资料(设置后优先于云控配置), 当 kTIMRequestInternalOperation 为 kTIMInternalOperationRequestFriendInfoWhenFetchingGroupMemberList 时需要设置
static const char* kTIMRequestFriendInfoWhenFetchingGroupMemberListParam = "request_friend_info_when_fetching_group_member_list_param";
