...
class LiveMainCollectionCell: UICollectionViewCell {
    ...
    static let CellID: String = "LiveMainCollectionCell"
...
extension LiveMainCollectionCell {

    public func config(_ item: LiveMainItemModel) {
