...
class VRCoHostView: UIView {
    ...
    private lazy var avatarImageView: UIImageView = {
        ...
        imageView.kf.setImage(with: URL(string: seatInfo.userInfo.avatarURL), placeholder: UIImage.avatarPlaceholderImage)
        return imageView
    }()

    private lazy var userInfoView = VRUserStatusView(userInfo: seatInfo.userInfo)

    private lazy var soundWaveView = VRCoHostSoundWaveView()
    ...
    private func constructViewHierarchy() {
        ...
        insertSubview(soundWaveView, belowSubview: avatarImageView)
    }
    ...
    private func activateConstraints() {
        ...
        soundWaveView.snp.makeConstraints { make in
            ...
            make.width.equalTo(avatarImageView).multipliedBy(1.5)
            make.height.equalTo(avatarImageView).multipliedBy(1.5)
        }
    }
