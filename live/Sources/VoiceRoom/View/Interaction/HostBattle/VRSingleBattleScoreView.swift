...
class VRSingleBattleScoreView: UIView {
...
extension VRSingleBattleScoreView {
    ...
    private func activateConstraints() {
        ...
        dividerImageView.snp.makeConstraints { make in
            make.top.equalToSuperview()
            make.leading.equalTo(leftScoreBar.snp.trailing).offset(-7.scale375Height())
            make.height.width.equalTo(14.scale375Height())
        }
    ...
    private func updateScoreBarsLayout() {
        ...
        UIView.animate(withDuration: 0.5) { [weak self] in
            ...
            self.dividerImageView.snp.remakeConstraints { make in
                ...
                make.width.height.equalTo(14.scale375Height())
            }
            self.layoutIfNeeded()
        }
    }
