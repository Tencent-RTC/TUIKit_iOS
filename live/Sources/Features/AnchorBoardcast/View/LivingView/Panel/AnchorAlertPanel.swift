...
struct AnchorAlertInfo {
    ...
    let timeoutClosure: AnchorAlertButtonClickClosure?
    ...
    init(description: String, 
         ...
         timeoutClosure: AnchorAlertButtonClickClosure? = nil) {
...
class AnchorAlertPanel: UIView {
    ...
    init(alertInfo: AnchorAlertInfo, autoDismissAfter seconds: Int = 0) {
