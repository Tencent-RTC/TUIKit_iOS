...
fileprivate extension String {
    static var orderedText: String = ("karaoke_ordered").liveLocalized
    static var orderedCountText: String = ("karaoke_ordered_count").liveLocalized
    static var exitOrder: String = ("karaoke_exit_order").liveLocalized
    static var SongText: String = ("karaoke_order_song").liveLocalized
    static var originalText: String = ("karaoke_original").liveLocalized
    static var scoreText: String = ("karaoke_score").liveLocalized
}
