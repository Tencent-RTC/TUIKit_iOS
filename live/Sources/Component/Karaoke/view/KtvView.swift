...
public class KtvView: UIView {
    ...
    private lazy var lyricsView: LyricsView = {
        let view = LyricsView(isKTV: isKTV)
        return view
    }()
...
fileprivate extension String {
    static let waitingTipsText = ("karaoke_audience_waiting_tips").liveLocalized
    static let pauseText = ("karaoke_song_pause").liveLocalized
}
