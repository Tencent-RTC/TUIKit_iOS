...
protocol PitchCanvasDelegate: NSObject {
    func updatePitchIndicatorPosition(endPoint: CGPoint)
}

class PitchCanvas: UIView {
    weak var delegate: PitchCanvasDelegate?
    private var config: PitchViewConfig?
    private var backgroundImageView: UIImageView?
    private var stdPitchModelsToDraw: [PitchModel] = []
    private var hitPitchModelsToDraw: [PitchModel] = []
    ...
    func drawWithProgress(progress: Int, stdPitchModels: [PitchModel], hitPitchModels: [PitchModel], pitch: Int) {
    ...
    private func drawPitchModels(pitchModels: [PitchModel], fillColor: UIColor) {
        ...
        var mergedModels: [PitchModel] = []
        var currentModel: PitchModel? = nil
        ...
        for model in sortedModels {
            ...
            let newModel = PitchModel(startTime: model.startTime,
        ...
        for model in mergedModels {
            ...
            let w = msWidth * CGFloat(model.duration)
            let h = pitchHeight
