...
fileprivate extension String {
    static var voiceEarMonitor: String = ("karaoke_setting_ear_return").liveLocalized

    static var audioSetting: String = ("karaoke_setting_audio").liveLocalized

    static var captureVolume: String = ("karaoke_setting_capture_volume").liveLocalized

    static var playoutVolume: String = ("karaoke_setting_playback_volume").liveLocalized

    static var voicePitch: String = ("karaoke_setting_music_pitch").liveLocalized

    static var reverb: String = ("karaoke_change_reverb").liveLocalized

    static var Original: String = ("karaoke_original").liveLocalized

    static var child: String = ("karaoke_voice_child").liveLocalized

    static var girl: String = ("karaoke_voice_girl").liveLocalized

    static var uncle: String = ("karaoke_voice_uncle").liveLocalized

    static var ethereal: String = ("karaoke_voice_ethereal").liveLocalized

    static var withoutEffect: String = ("karaoke_reverb_none").liveLocalized

    static var karaoke: String = ("karaoke_reverb_ktv").liveLocalized

    static var metal: String = ("karaoke_reverb_metallic").liveLocalized

    static var low: String = ("karaoke_reverb_low").liveLocalized

    static var loud: String = ("karaoke_reverb_loud").liveLocalized

    static var done: String = ("karaoke_setting_done").liveLocalized

    static var score: String = ("karaoke_score").liveLocalized

    static var pitchSetting: String = ("karaoke_setting_pitch_shift").liveLocalized

    static var trackSwitchNotSupportedText = ("karaoke_cant_switch_tracks").liveLocalized
}
