...
public class MusicSettingViewController: UIViewController {
    ...
    private let doneButton: UIButton = {
        let button = UIButton()
        button.setTitle(.musicSettingDoneText, for: .normal)
...
fileprivate extension String {
    static let musicSettingTitle: String = ("karaoke_setting_tune").liveLocalized
    static let musicSettingDoneText: String = ("karaoke_setting_done").liveLocalized
}
