...
extension KaraokeManager {
    ...
    func resetAudioEffect() {
        ...
        trtcCloud.setAudioQuality(.default)
    }

    func setMediaVolumeType() {
...
fileprivate extension String {
    static let loadFailedText = ("karaoke_music_loading_error").liveLocalized
    static let trackSwitchNotSupportedText = ("karaoke_cant_switch_tracks").liveLocalized
}
