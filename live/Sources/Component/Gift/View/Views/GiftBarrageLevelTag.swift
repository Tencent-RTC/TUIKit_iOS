...
enum GiftBarrageLevelConfig {
    static let isEnabled: Bool = true
}

enum GiftBarrageLevel: Int {
    case level1 = 1
    case level2 = 2
    case level3 = 3
    case level4 = 4
    ...
    static func from(level: Int) -> GiftBarrageLevel? {
        switch level {
...
enum GiftBarrageLevelTagRenderer {
    ...
    static func image(for level: GiftBarrageLevel, text: String) -> UIImage {
